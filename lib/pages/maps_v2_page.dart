...
import 'package:week6_maps/map_type_google.dart';
...
final Completer<GoogleMapController> _controller =
        ...
        child: Material(
          ...
          child: Column(
            children: [
              ...
              ElevatedButton(
                onPressed: () {
                  getCurrentPositon().then((value) async {
                    setState(() {
                      devicePostion = value;
                    });
              ...
              devicePostion != null
                ? Text("Lokasi saat ini : ${devicePostion?.latitude}${devicePostion?.longitude}")
  ...
  Future<Position?> getCurrentPositon() async {
